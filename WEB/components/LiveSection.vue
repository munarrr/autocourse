  ...
  <section class="live-section">
    <div class="auto-container">
      <div class="sec-title centered">
        <h2>Видеобзор автошколы<span class="dot">.</span></h2>
      </div>
      <div class="main-image-box">
        <div class="image-layer" style="background-image: url(/images/resource/about.jpg);"></div>
        <div class="inner clearfix">
          <div class="round-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
            <div class="round-inner">
              ...
              <div class="title">
                <h3>Немного о <br>нас</h3>
              </div>
              <div class="more-link"><nuxt-link to="/about">Подробнее</nuxt-link></div>
            </div>
          </div>
        </div>
      </div>
