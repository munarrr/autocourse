    ...
    <div class="auto-container">
      ...
      <div class="mixitup-gallery">
        <div class="upper-row clearfix">
          <div class="sec-title">
            <h2>как проходять занятие в нашем автошколе<span class="dot">.</span></h2>
          </div>
          <!--Filter-->
          <div class="filters clearfix">
            <ul class="filter-tabs filter-btns clearfix">
              <li class="filter mixitup-control-active" data-role="button" data-filter="all">Все<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".branding">автомобили<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".illustration">на дороге<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".photography">учебный класс<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".web-design">вождение<sup></sup></li>
            </ul>
          </div>
        </div>
