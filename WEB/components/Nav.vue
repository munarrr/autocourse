      ...
      <div class="inner-container clearfix">
        ...
        <div class="logo-box">
          <div class="logo"><a href="/" title="Linoor - Digital Agency Template"><img
            src="/images/mad-max.png" id="thm-logo" alt="Linoor - DIgital Agency HTML Template"
          ...
          <nav class="main-menu navbar-expand-md navbar-light">
            <div class="collapse navbar-collapse show clearfix">
              <ul class="navigation clearfix">
                ...
                <li class="dropdown"><nuxt-link to="/services">Сервисы</nuxt-link>
                  <ul>
                ...
                <li class="dropdown"><nuxt-link to="/portfolio">Проекты</nuxt-link>
                  <ul>
                ...
                <li class="dropdown"><nuxt-link to="/blog-grid">Новости</nuxt-link>
                  <ul>
          ...
          <div class="link-box">
            <div class="call-us">
              <a class="link" href="tel:6668880000">
                ...
                <span class="sub-text">Звонок</span>
                <span class="number">055342323</span>
              </a>
            </div>
          </div>
        </div>
